...
#     array.select! { |element| element.gsub(/[@]/,'').size == 5}.count
# end

# def maj(array)

#     while array = A..Z
#     puts capitalize(array)
#     end
# end

# def handle_by_size(array)
#     if array.size < array.size
# end

#pour lancer la méthode short_long j'ai besoin de la taille des handle
#afficher les handle du plus petit au plus grand
